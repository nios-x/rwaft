      ...
      <section className="deploy-shell">
        ...
        <div className="form-container">
          <div className="tab-switcher">
            <button 
              type="button" 
              className={`tab-btn ${mode === 'github' ? 'active' : ''}`}
              onClick={() => { setMode('github'); setError(''); setDeploymentUrl(''); }}
            ...
            <button 
              ...
              onClick={() => { setMode('prompt'); setError(''); setDeploymentUrl(''); }}
              disabled={isDeploying}
            >
              AI Prompt
            </button>
          ...
          <form className="deploy-form" onSubmit={handleDeploy}>
            {mode === 'github' ? (
              <>
                ...
                <button type="submit" disabled={isDeploying} className="submit-btn">
              ...
              <>
                ...
                <div className="input-wrap textarea-wrap">
                  <textarea
                    ...
                    required
                    rows={4}
                    placeholder="A beautiful pomodoro timer app with a dark mode, ambient sound selector, and circular progress bar..."
                    value={promptText}
                ...
                <button type="submit" disabled={isDeploying} className="submit-btn">
                  {isDeploying ? 'Generating & Deploying...' : 'Generate & Deploy'}
                  {!isDeploying && <span aria-hidden="true">↗</span>}
                </button>
